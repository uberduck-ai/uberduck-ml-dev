...
index = {"ensure_speaker_table": "data.cache.ipynb",
         ...
         "ALLOWED_EMOJIS": "models.torchmoji.ipynb",
         ...
         "symbols_russian": "text.symbols.ipynb",
         "RUSSIAN_SYMBOLS": "text.symbols.ipynb",
         "symbols_ukrainian": "text.symbols.ipynb",
         "UKRAINIAN_SYMBOLS": "text.symbols.ipynb",
