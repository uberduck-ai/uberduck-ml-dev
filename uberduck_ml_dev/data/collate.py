...
# NOTE (Sam): collation is a rather general idea - this should work for Tacotron and Hifigan.
# We could consider adding back in sorting by length for onxx compability if we want to use this function in batched inference.
class Collate:
    def __init__(
        self,
    ...
    def __call__(self, batch):
        ...
        if return_audio:
            ...
            output["audio_padded"] = audio_padded
        ...
        if return_text_sequences:
            ...
            output["text_int_padded"] = text_padded
            output["input_lengths"] = input_lengths  # rename "text lengths"
        ...
        if return_mels:
            ...
            output["mel_padded"] = mel_padded
            output[
                "mel_lengths"
            ] = mel_lengths  # renamed "mel lengths" from "output_lengths" - probably breaks tacotron2
            output["gate_padded"] = gate_padded
...
# NOTE (Sam): list collation rather than dictionary collation is confusing and should be banished.
